...
namespace LogLibrary
{
    public class CView: ICloneable
    {
        ...
        public int NameCount(string name) { int acc = 0; foreach (CTrace trace in Traces) foreach (CEvent evt in trace.Events) if (evt.Name != null && evt.Name == name) acc += 1; return acc; }
        /// <summary>
